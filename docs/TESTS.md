...
| `test_m1_hardening.py` | 71 | **New 2026-07-31 — worker-isolation hardening (`docs/AUTOLOOP.md` §4e, `docs/SECURITY.md` S23-S26); +6 across two rounds of same-day follow-up (S25/S26 addenda); +13 on 2026-08-16 (esc-01, §2b — the derived-bytecode exemption).** See the narrative entries above this table for the full description; self-contained, real git throughout, no shared fixtures imported from other test files. |
